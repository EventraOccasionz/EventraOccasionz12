...
import { verifyFirebaseConnection, db, auth } from '../services/firebase';
...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TEMPORARY BYPASS: 2FA system is temporarily disabled as requested
      await logSecurityEvent('LOGIN_SUCCESS_BYPASS_2FA', 'Email and password verified, 2FA bypassed temporarily', emailClean);
      ...
      /* ORIGINAL 2FA CHECK BLOCK (Commented out for temporary bypass)
