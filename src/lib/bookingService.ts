...
export const bookingService = {
  ...
  async submitRSVP(rsvp: Partial<RSVP>): Promise<void> {
    ...
    if (rsvp.family_id === 'preview_family') {
      console.log('[Preview Mode] Intercepted RSVP submission. Bypassing Firestore write.');
      return;
    }
  ...
  async submitTransport(transport: Partial<TransportRequest>): Promise<void> {
    if (transport.family_id === 'preview_family') {
      console.log('[Preview Mode] Intercepted Transport submission. Bypassing Firestore write.');
      return;
    }
    if (!authService.isConfigured()) {
