...
import { Family, RSVP, TransportRequest, RoomBooking, EventData } from '../../types';
...
export default function EventDetailsDashboard({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'setup' | 'guests' | 'logistics' | 'tasks' | 'vendors' | 'budget' | 'timeline' | 'staff' | 'reports'>('overview');
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2 border-b border-white/5 pb-4 overflow-x-auto select-none no-scrollbar">
        {[
          ...
          { id: 'setup', label: 'Guest Experience Setup', icon: <Sparkles size={14} /> },
