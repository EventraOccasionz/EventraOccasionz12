...
import EventExperienceSettingsPanel from './EventExperienceSettingsPanel';
...
interface EventDetailsDashboardProps {
  ...
  initialTab?: 'overview' | 'guests' | 'logistics' | 'tasks' | 'vendors' | 'budget' | 'timeline' | 'experience' | 'staff' | 'reports';
}
...
export default function EventDetailsDashboard({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'guests' | 'logistics' | 'tasks' | 'vendors' | 'budget' | 'timeline' | 'experience' | 'staff' | 'reports'>(initialTab);
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2 border-b border-white/5 pb-4 overflow-x-auto select-none no-scrollbar">
        {[
          ...
          { id: 'experience', label: 'Invitation & RSVP', icon: <Sparkles size={14} /> },
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            {/* INVITATION & RSVP SETTINGS TAB */}
            {activeTab === 'experience' && (
              <EventExperienceSettingsPanel event={event} showToast={showToast} />
            )}
