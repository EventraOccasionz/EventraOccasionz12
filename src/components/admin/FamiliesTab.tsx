...
import { Trash2, QrCode, X, Printer, Edit2, Upload, Loader2, Image as ImageIcon, Save, Check, Type, FileText, Download, Copy, Plus } from 'lucide-react';
          ...
          {filteredFamilies.length === 0 && (
            <tr>
              <td colSpan={7} className="py-20 text-center">
                <p className="text-text-secondary uppercase tracking-widest opacity-40 mb-4 text-xs font-mono">No passcode rosters exist.</p>
                {onAddClick && (
                  <button
                    onClick={onAddClick}
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-gold hover:bg-gold/90 text-dark text-xs uppercase tracking-widest font-bold rounded-lg transition-all shadow-md active:scale-95"
                  >
