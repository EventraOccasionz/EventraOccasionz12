...
export default function CorporateGuestExperience({ family, event, eventId }: CorporateGuestExperienceProps) {
  ...
  useEffect(() => {
    if (timeline.length > 0 && selectedSessions.length === 0 && !rsvpData) {
      setSelectedSessions(timeline.map((item: any) => item.name || item.title));
    }
  }, [timeline, rsvpData]);
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 relative z-10">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
                    Welcome to the Global Executive Experience
                  </h2>
                  <p className="text-xs sm:text-sm text-slate-400 mt-4 leading-relaxed font-sans max-w-xl">
                    Prasanna Celebrations is honored to host your delegation at <span className="text-cyan-400 font-semibold">{eventName}</span>. Utilize this modern portal to configure your attendance preferences, agenda planners, private shuttle logistics, and hotel stays.
                  </p>
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[10px] font-mono text-cyan-400/80 mt-1">{slot.time}</p>
                                  </div>
                                </div>
                              );
                            })}
