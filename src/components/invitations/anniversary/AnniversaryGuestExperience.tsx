...
export default function AnniversaryGuestExperience({ family, event, eventId }: AnniversaryGuestExperienceProps) {
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 relative z-10">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-3xl sm:text-4xl font-serif font-bold text-cream leading-tight">
                    Celebrating a Beautiful Journey of Love
                  </h2>
                  <p className="text-xs sm:text-sm text-rose-200/80 mt-4 leading-relaxed font-sans max-w-xl">
                    We invite you to share in our celebration of togetherness, joy, and beautiful memories. Join us at the grand reception of <span className="text-rose-300 font-semibold">{coupleName}</span>. Your presence on this momentous occasion is a true blessing to our lives.
                  </p>
                    ...
                    <div className="mt-3.5 space-y-2.5 max-h-[130px] overflow-y-auto pr-1">
                      {timeline.map((slot: any, idx: number) => (
                        <div key={idx} className="text-xs font-mono flex items-start gap-2 border-l-2 border-rose-500/20 pl-2.5 py-0.5">
                          <span className="text-rose-400 font-bold whitespace-nowrap">{slot.time}</span>
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[10px] font-mono text-rose-400/80 mt-1">{slot.time}</p>
                                  </div>
                                </div>
                              );
                            })}
