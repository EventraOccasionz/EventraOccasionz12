...
export function CorporateGuestExperience({ family, event, eventId }: GuestExperienceProps) {
  return <CorporateGuestExperienceComponent family={family} event={event} eventId={eventId} />;
}

// 3. Anniversary Guest Experience
export function AnniversaryGuestExperience({ family, event, eventId }: GuestExperienceProps) {
  return <AnimatePresenceComponent family={family} event={event} eventId={eventId} />;
}

function AnimatePresenceComponent({ family, event, eventId }: GuestExperienceProps) {
  return <AnniversaryGuestExperienceComponent family={family} event={event} eventId={eventId} />;
}

// 4. Baby Shower Guest Experience
export function BabyShowerGuestExperience({ family, event, eventId }: GuestExperienceProps) {
  return <BabyShowerGuestExperienceComponent family={family} event={event} eventId={eventId} />;
}

// 5. Engagement Guest Experience
export function EngagementGuestExperience({ family, event, eventId }: GuestExperienceProps) {
  return <EngagementGuestExperienceComponent family={family} event={event} eventId={eventId} />;
}

// 6. Generic Guest Experience
export function GenericGuestExperience({ family, event, eventId }: GuestExperienceProps) {
  return <GenericGuestExperienceComponent family={family} event={event} eventId={eventId} />;
}
...
export default function GuestExperienceRouter({ family, event, slug }: GuestExperienceRouterProps) {
  ...
  const normalizedEventType = String(rawEventType).trim().toLowerCase();
  ...
  } else if (['baby shower', 'baby_shower', 'baby-shower'].includes(normalizedEventType)) {
  ...
  switch (normalizedEventType) {
    case 'birthday':
      return <BirthdayGuestExperience family={family} event={event} eventId={eventId} />;
    case 'corporate':
      return <CorporateGuestExperience family={family} event={event} eventId={eventId} />;
    case 'anniversary':
      return <AnniversaryGuestExperience family={family} event={event} eventId={eventId} />;
    case 'baby shower':
    case 'baby_shower':
    case 'baby-shower':
      return <BabyShowerGuestExperience family={family} event={event} eventId={eventId} />;
    case 'engagement':
      return <EngagementGuestExperience family={family} event={event} eventId={eventId} />;
    default:
      return <GenericGuestExperience family={family} event={event} eventId={eventId} />;
  }
}
