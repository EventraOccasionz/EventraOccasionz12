      ...
      <div className="relative group">
        ...
        <div className="flex animate-scroll hover:pause">
          {[...testimonials, ...testimonials].map((t, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-80 md:w-96 bg-white/5 border border-gold/10 p-8 mx-3 relative hover:border-gold/30 hover:bg-white/[0.08] transition-all duration-300"
            >
              ...
              <p className="text-[0.72rem] tracking-[0.15em] uppercase text-gold mb-1 font-medium group-hover:text-gold-light transition-colors">{t.name}</p>
