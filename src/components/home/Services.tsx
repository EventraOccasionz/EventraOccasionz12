          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((cat, i) => (
              <motion.div
                ...
                className="group relative h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-gold/10 bg-dark-1/20 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(201,168,76,0.15)] hover:border-gold/30 transition-all duration-500"
              >
                {/* Premium Image */}
                <img
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full">
                  ...
                  <p className="text-sm text-text-secondary font-light mb-6 line-clamp-2 group-hover:text-text-primary transition-colors duration-300">
                      {cat.shortDesc}
                  </p>
                  <Link
