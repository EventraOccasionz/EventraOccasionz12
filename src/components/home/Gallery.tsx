...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="bg-dark-1 py-16 sm:py-24 lg:py-32 px-4 sm:px-8 lg:px-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl text-cream mb-6">Moments of <em className="italic text-gold">Splendor</em></h2>
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-10 sm:mb-16">
          {['all', 'wedding', 'birthday', 'corporate'].map((cat) => (
            <button
              ...
              className={`px-4 sm:px-5 py-1.5 border text-[0.68rem] tracking-[0.14em] uppercase transition-all
                ${filter === cat 
            ...
            <AnimatePresence mode="popLayout">
              {filteredItems.map((item, id) => (
                <motion.div
                  ...
                  className="group relative h-72 sm:h-80 md:h-96 overflow-hidden cursor-pointer rounded-xl border border-white/5 hover:border-gold/30 transition-colors duration-300"
                >
