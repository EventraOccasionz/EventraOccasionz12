...
export default function BookingForm() {
  ...
  return (
    <section id="booking" className="bg-dark-2 py-16 sm:py-24 lg:py-32 px-4 sm:px-8 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl text-cream mb-6">Book Your <em className="italic text-gold">Event</em></h2>
        ...
        {isSubmitted ? (
          <motion.div
            ...
            className="premium-card p-6 sm:p-12 text-center"
          >
            <CheckCircle2 className="text-gold mx-auto mb-6" size={60} />
            <h3 className="font-serif text-2xl sm:text-3xl text-cream mb-4">Enquiry Received</h3>
            <p className="text-text-secondary italic text-sm sm:text-base">"Your vision is now our mission. We will reach out within 24 hours."</p>
          </motion.div>
        ) : (
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-[#121212] p-5 sm:p-8 md:p-12 border border-white/5 rounded-2xl">
            ...
            <div className="flex flex-col gap-2">
              ...
              <select 
                ...
                className="bg-black/40 border border-white/10 rounded-xl p-4 text-text-primary outline-none focus:border-gold transition-colors appearance-none cursor-pointer"
              >
