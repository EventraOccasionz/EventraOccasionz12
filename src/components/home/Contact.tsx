...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-dark-2 py-16 sm:py-24 lg:py-32 px-4 sm:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start mb-12 sm:mb-20 lg:mb-24">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl text-cream mb-6">Let's <em className="italic text-gold">Connect</em></h2>
          ...
          <div className="flex flex-col gap-5 mb-8">
            <div className="bg-white/5 border border-gold/10 p-5 sm:p-6 flex gap-4 sm:gap-6 items-start hover:border-gold/40 transition-colors">
              ...
              <div>
                ...
                {venueSettings.google_maps_url && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="text-gold text-xs hover:underline inline-flex items-center gap-1 font-mono uppercase mt-2 border border-gold/15 bg-gold/5 px-2.5 py-1 rounded hover:bg-gold/20 hover:border-gold/40 transition-all"
                  >
                    Open in Google Maps ↗
                  </a>
                )}
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-3 px-6 sm:px-8 py-3.5 bg-[#25d366] text-white text-[0.74rem] tracking-widest uppercase transition-all hover:brightness-110 hover:-translate-y-1 font-semibold"
            >
          ...
          <div className="mt-12">
            ...
            <div className="space-y-2 max-w-xs">
              <div className="flex justify-between text-sm py-1 border-b border-white/5 hover:bg-white/[0.02] transition-colors px-2 -mx-2 rounded">
              ...
              <div className="flex justify-between text-sm py-1 hover:bg-white/[0.02] transition-colors px-2 -mx-2 rounded">
        ...
        <motion.div
           ...
           whileInView={{ opacity: 1, x: 0 }}
           viewport={{ once: true }}
           className="bg-dark-3 border border-gold/20 p-5 sm:p-8 md:p-12 relative w-full"
        >
          {isSubmitted ? (
            <motion.div 
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="max-w-7xl mx-auto w-full h-[300px] sm:h-[400px] border border-gold/20 relative grayscale hover:grayscale-0 transition-all duration-500"
      >
        <iframe 
